	...
	class AllAroundAjax
	{
		...
		public function alarnd_get_product_val()
		{
			...
			<div class="alarnd--price-by-shirt">
				<p class="alarnd--group-price"><?php echo wc_price($final_price, array('decimals' => 0)); ?> /
					<?php echo esc_html($first_line_keyword); ?>
				</p>
				<p><?php echo esc_html($second_line_keyword); ?>: <span class="alarnd__total_qty"><?php echo $total_qty; ?></span>
				</p>
			</div>
			<?php
			wp_die();
